  ...
  return (
    <>
                ...
                <Box p={1}>
                  <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
                    ...
                    <Button
                      ...
                      variant="contained"
                      size="small"
                      onClick={() => setSelectedTopic({ ...topic, professor })}
                    >
                      Prijavi
                    </Button>
                  </Box>
      ...
      <ConfirmDialog
        ...
        open={!!selectedTopic}
        handleAccept={async () => {
          await applicationsApi.apply({ topic: selectedTopic.id, mentor: selectedTopic.professor.id });
          setSelectedTopic(null);
          queryClient.invalidateQueries('studentTopics');
